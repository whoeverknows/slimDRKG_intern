...
Format: ![Figure Interactions in the DRKG. The number next to an edge indicates the number of relation-types for that entity-pair in DRKG.](./knowledge graph.png)
